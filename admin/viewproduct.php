         ...
         <input type="hidden" value="<?php echo $proid; ?> " name='proid'>
            <table class="form">
                ...
                <tr>
                    ...
                    <td>
                        <input readonly type="text" value="<?php echo $fetchproduct['productname']; ?>" name='productname' placeholder="Enter Product Name..." class="medium" />
                    </td>
                </tr>
				<tr>
                    <td>
				...
				<tr>
                    ...
                    <td>
                       <input readonly value="<?php echo $fetchproduct['brandname']; ?>" type="text" name='brandname' placeholder="Brand Name">
                    </td>
                </tr>
				 ...
				 <tr>
                    ...
                    <td>
                        <textarea readonly='readonly' class="tinymce" name='description'>
				...
				<tr>
                    ...
                    <td>
                        <input readonly type="text" value='<?php echo $fetchproduct['price']; ?>' name='price' placeholder="Enter Price..." class="medium" />
                    </td>
                </tr>
				...
				<tr>
                    ...
                    <td>
                        <input readonly type="text" value="<?php echo $fetchproduct['weight']; ?>" name='weigth' placeholder="weight ( KG )" >  (If It Is Under 1kg then use float Number . <i>Example '0.500'</i>)
                    </td>
                </tr>
