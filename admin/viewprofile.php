              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="upload/<?php if($fetchtrainer['profilepicture']){ echo $fetchtrainer['profilepicture'];}else { echo "avatar.JFIF";} ?>" alt="Admin" class="" style="width: 150px;
                    height: 150px;border-radius:50%;">
                    <div class="mt-3">
                      <h4><?php echo $fetchtrainer['fname'].' '.$fetchtrainer['lname']; ?></h4>
                     
                      <a href="https://wa.me/<?php $fetchtrainer['whatsapp']; ?>" class="btn btn-primary">Join Whatsapp</a>
